        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sm text-brand-grey max-w-sm leading-relaxed">
              Ihr zuverlässiger B2B-Partner für erstklassige Nutzfahrzeuge im Raum Leichlingen, Köln und Düsseldorf. Wir sichern Ihre gewerbliche Mobilität – flexibel, schnell und unkompliziert.
            </p>
